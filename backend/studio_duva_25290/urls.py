"""studio_duva_25290 URL Configuration
...
admin.site.site_header = "Studio duva"
admin.site.site_title = "Studio duva Admin Portal"
admin.site.index_title = "Studio duva Admin"

# swagger
api_info = openapi.Info(
    title="Studio duva API",
    default_version="v1",
    description="API documentation for Studio duva App",
)
